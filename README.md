...
- ✅ **Listbox com seleção múltipla** (segure Ctrl para selecionar várias)
- ✅ **Botão "+" para adicionar categorias customizadas**
- ✅ **Seletor visual de ícones** com mais de 100 opções
